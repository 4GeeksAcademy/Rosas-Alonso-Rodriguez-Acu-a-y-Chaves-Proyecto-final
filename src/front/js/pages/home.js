        ...
        <div className="container mt-4 ">
                ...
                <div className="col-md-6">
                    ...
                    <div>
                        Patas Perdidas es una plataforma digital diseñada para <strong>ayudar a las personas a encontrar o reportar
                            mascotas perdidas y encontradas en su zona.</strong> Nuestro objetivo es conectar a las personas con mascotas que
            ...
            <div className="row md-5 bg-light bg-opacity-75 rounded-1 mb-4 p-4">
                <div className="col-md-6">
                    ...
                    <div>
                        El mapa es una de las herramientas principales en Patas Perdidas. <strong>Te permite visualizar las mascotas
                            perdidas y encontradas cerca de tu ubicación.</strong> Para interactuar con el mapa:
                        <ul>
