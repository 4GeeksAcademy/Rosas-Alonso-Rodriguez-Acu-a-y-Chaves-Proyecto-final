		...
		<div className="container mt-4 ">
            ...
            <div className="row md-5 bg-light bg-opacity-75 rounded-1 mb-4 p-4">
                <div className="col-md-6">
                    ...
                    <p>
                        ...
                        mascotas perdidas y encontradas en su zona. Nuestro objetivo es conectar a las personas con mascotas que
            ...
            <div className="par row md-5 bg-light bg-opacity-75 rounded-1 mb-4 p-4">
                <div className="col-md-6 order-md-2">
                    ...
                    <p>
                        Para publicar una mascota perdida o encontrada, solo necesitas seguir unos simples pasos:
                        <ol>
            ...
            >
                    ...
                    <div className=" col">
                        <Link to="/newpetlost">
                            <button className="btn btn-danger col-6 mx-auto adlam-display-regular  rounded-pill shadow">Perdí a mi mascota</button>
                        </Link>
                    </div>
                    <div className="col">
                        <Link to="/newpetfound">
                            <button className="btn btn-success col-6 mx-auto adlam-display-regular  rounded-pill shadow">Encontré una mascota</button>
                        </Link>
                    </div>
                    </div>
            </div>
            ...
            <div className="row md-5 bg-light bg-opacity-75 rounded-1 mb-4 p-4">
                <div className="col-md-6">
                    ...
                    <p>
                        El mapa es una de las herramientas principales en Patas Perdidas. Te permite visualizar las mascotas
                        perdidas y encontradas cerca de tu ubicación. Para interactuar con el mapa:
                        <ul>
            ...
            <div className="par row md-5 bg-light bg-opacity-75 rounded-1 p-4">
                <div className="col-md-6 order-md-2">
                    <h3 className="adlam-display-regular user-title">¿Cómo contactar con el usuario?</h3>
                    <p>
                        Si has encontrado una mascota que está reportada en el mapa, o si has visto una publicación de tu mascota perdida, puedes contactar
                        al usuario que la publicó. Para hacerlo:
                        <ul>
