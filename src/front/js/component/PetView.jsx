...
const PetsView = () => {
  ...
  useEffect(() => {
    const petData = [
      ...
      { id: 2, name: "Bella", type: "gato", color: "blanco", sex: "hembra", size: "pequeño", image:"https://media.istockphoto.com/id/465377790/es/foto/salto-golden-retriever-cachorro.jpg?s=612x612&w=0&k=20&c=HVymMnER-YmYt4ucnHr-_IMFTkctwJJtjgbNUwUnP9g=" },
      { id: 3, name: "Rocky", type: "gato", color: "marrón", size: "mediano", image: "https://i.pinimg.com/236x/3a/2a/bb/3a2abb553a0a8e46bfb03d3ade3e16a4.jpg" },
      { id: 4, name: "Spike", type: "gato", color: "verde", size: "pequeño", image: "https://images.unsplash.com/photo-1690214141978-3a038a437dec?fm=jpg&q=60&w=3000&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8Z2F0aXRvJTIwZW4lMjBsYSUyMGNhbWF8ZW58MHx8MHx8fDA%3D" },
      { id: 5, name: "Luna", type: "otro", color: "gris", size: "grande", image: "/img/luna.jpg" },
      { id: 6, name: "Bella", type: "reptil", color: "multicolor", size: "pequeño", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnB0qDUMHiTPHKPj24FukJX7OU3DvIQOmOnw&s" },
